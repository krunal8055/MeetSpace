MeetSpace is restricted to specific users. This Application is for all only those users who use the mobile applications and it are limited to the college staff.
